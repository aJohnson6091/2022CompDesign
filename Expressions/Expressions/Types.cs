...
namespace Expressions
{
    ...
    {
        public string name;
        public DataLocation(string n) { this.name = n; }
        public override string ToString()
        {
            return this.name;
        }
    ...
    public class RegisterLocation : DataLocation
    {
        public RegisterLocation(string name) : base(name)
        {
        }
    }

    public class XMMLocation : DataLocation
    {
        public XMMLocation(string name) : base(name)
        {
        }
    }
}
